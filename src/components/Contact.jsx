...
const Contact = () => {
  ...
  return (
    ...
    overflow-hidden' id='Contact'>
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'> Connect <span
        className='underline
         underline-offset-4 decoration-1 under font-light '>With Us</span>
        </h1>
        ...
        <div className="text-green-600 mt-4">{result}</div>
    </div>
  )
}

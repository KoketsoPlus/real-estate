...
const About = () => {
  return (
    <div className='flex flex-col items-center justify-center
        constainer mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden'
        id='About'>
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20 '>
            ...
            <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                ...
                quia neque atque, quibusdam illum dolore nostrum repellat! Aperiam dolores esse,
                recusandae cum, optio nulla laborum, hic consequuntur maxime ullam quasi?
                </p>

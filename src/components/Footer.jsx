  ...
  return (
    ...
    overflow-hidden' id='Footer'>  
         ...
         items-start'>
            <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                ...
                <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Doloribus minus reprehenderit, ipsa assumenda asperiores, 
                    possimus aperiam atque modi consectetur a quae tempora ea ratione
                    aliquid animi culpa veritatis non commodi.
                    </p>
            </div>
        ...
        <div className='border-t border-gray-700 mt-10 py-4 text-center text-gray-500'>
          Copyright 2025 &copy; Chabalala Properties. All rights reserved. 
        </div>
